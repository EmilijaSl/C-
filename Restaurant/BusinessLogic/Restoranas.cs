...
namespace Restaurant.BusinessLogic
{
    public class Restoranas
    {
        ...
        public PadavejosRepozitorija padavejosRepozitorija { get; set; }
        ...
        public Restoranas()  
        {
            ...
            padavejosRepozitorija = new PadavejosRepozitorija();
            staliukoRepozitorija = new StaliukoRepozitorija();
        }
       
        public void UserInterface()
        {
            Console.WriteLine("Sveiki !\n\nRestorano sistema jungiasi");
            Console.ReadLine();
            var padaveja = NaujaPadaveja(padavejosRepozitorija);
        ...
        public void Meniu(Padaveja padaveja, List<BendraInformacija> informacija)
        {
        ...
        public static Padaveja NaujaPadaveja(PadavejosRepozitorija padavejosRepozitorija)
        {
            Console.Clear();
            Console.WriteLine("Iveskite savo ID");
            padavejosRepozitorija.RodykVisus();
            int padavejosID = Convert.ToInt32(Console.ReadLine());
            var padaveja = padavejosRepozitorija.RetriveByID(padavejosID);
            Console.Clear();
            Console.WriteLine("Prisijunge " + padaveja.PadavejosVardas);
            Console.ReadLine();
            return padaveja;
        }
        public void NaujasUzsakymas(List<BendraInformacija> maistas)
        {
            ...
            Console.Clear();
            Console.WriteLine("Jeigu norite pildyti uzsakyma spauskite 0 ");
        ...
        public void UzbaigtiUzsakyma(Padaveja padaveja)
        {
            ...
            RuostiCeki(uzsakymas, padaveja);
            Uzsakymai.Remove(Uzsakymai.First(x => x.StaliukoID == staliukoID));
            staliukoRepozitorija.PakeiskStaliukoStatusa(staliukoID, true);
            
        }
        public void RuostiCeki(Uzsakymas uzsakymas, Padaveja padaveja)
        {
            Console.Clear();
            string restoranui = CekisRestoranui(uzsakymas, padaveja);
            string klientui = CekisKlientui(uzsakymas, padaveja);
        ...
        public string CekisRestoranui(Uzsakymas uzsakymas, Padaveja padaveja)
        {
            string cekioInformacija = $"Data:{DateTime.Now}\nPadavejo ID:{padaveja.PadavejosID}\n" +
        ...
        public string CekisKlientui(Uzsakymas uzsakymas, Padaveja padaveja)
        {
            string cekioInformacija = $"Data:{DateTime.Now}\nJus aptarnavo padavejas {padaveja.PadavejosVardas}\n" +
                    $"Staliuko numeris:{uzsakymas.StaliukoID}\nID:  Patiekalas:  Kaina:\n";
            foreach (var item in uzsakymas.Informacija)
            {
